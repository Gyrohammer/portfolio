...
I got into homelabbing out of curioisty and need. My main need was to have a NAS (Network Attached Storage) for simple computer backup for both my system and my partners system. I also enjoyed the thought of self-hosting a variety of services that I would find useful such as:

## Jellfyin <img align="" width="20" height="20" src="/docs/homelab/assets/jellyfin_logo.PNG"/>
...
## Wireguard <img align="" width="20" height="20" src="/docs/assets/wireguard-icon.png"/>
...
## Photosync <img align="" width="20" height="20" src="/docs/assets/photosync-icon.png"/>
...
## Gameservers <img align="" width="20" height="20" src=""/>
...
## Network Management <img align="" width="20" height="20" src=""/>
My router is a OPNSense system running on an intel NUC. I also have unifi systems on my network which are controlled by a docker container on the main server. OPNSense was chosen to familiarize myself with enterprise implementations like PFSense and for data privacy. This NUC can also be used as another host if I were to set up a docker swarm for other projects.